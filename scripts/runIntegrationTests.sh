...
ALL_PC_INSTANCES_FOLDER="../target/instances" # Parent folder after within the endtoend target folder for where extracted folders should go
...
POM_LOCATION="../../../../pom.xml" # Relative to the extracted from inside the extracted PC instance folder (target/instances/$ZIP_EXTRACT/phenomecentral-standalone-*/)
